...
<div class='container'>
	<img src="/skin/frontend/base/default/proline_logo_new.png" alt="Proline Logo" class="spec-logo"/>
	<h1 class='spec-title'><?php echo $spec_sheet['name']['value'];?></h1>
	<div class='spec-drawing-container'>
	<a href="http://prolinestores.com/media/catalog/product<?php echo $spec_sheet['spec_drawing']['value'];?>">
	<img class='spec-drawing' alt="Spec Sheet for <?php echo $spec_sheet['name']['value'];?>" src="http://prolinestores.com/media/catalog/product<?php echo $spec_sheet['spec_drawing']['value'];?>"/>
	</a>
	</div>
